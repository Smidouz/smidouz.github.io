...
$(function(){$("#pagepiling").pagepiling({menu:null,direction:"vertical",verticalCentered:!0,sectionsColor:[],anchors:[],scrollingSpeed:300,easing:"swing",loopBottom:!1,loopTop:!1,css3:!0,navigation:!1,normalScrollElements:null,normalScrollElementTouchThreshold:5,touchSensitivity:5,keyboardScrolling:!0,sectionSelector:".section",animateAnchor:!1,onLeave:function(n,o,e){},afterLoad:function(n,o){},afterRender:function(){}})}),$(document).ready(function(){function n(){$(".main-head").css("height",$(window).height())}n(),$(window).resize(function(){n()})});