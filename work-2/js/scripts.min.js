...
$(function(){$(".top-line .sf-menu").superfish({cssArrows:!1,hoverClass:"no-class",delay:200});var e=$(".slider");e.owlCarousel({loop:!0,items:1,itemClass:"slide-wrap",nav:!0,navText:""}),$(".next").click(function(){e.trigger("next.owl.carousel")}),$(".prev").click(function(){e.trigger("prev.owl.carousel",[300])}),$("#my-menu").mmenu({extensions:["fx-menu-slide","fx-panels-slide-100","fx-listitems-slide"],navbar:{title:""}});var i=$("#my-menu").data("mmenu");$(".mobile-menu-wrap").click(function(){i.open(),i.close()}),$(".service-item__title").equalHeights(),$(".new-item__text").equalHeights(),$('a[href="#callback"]').magnificPopup({type:"inline",fixedContentPos:!1,fixedBgPos:!0,overflowY:"auto",closeBtnInside:!0,preloader:!1,midClick:!0,removalDelay:300,mainClass:"my-mfp-slide-bottom"}),$('a[href="#callback"]').click(function(){$("#callback .formname").val($(this).data("form"))})}),$(document).ready(function(){$("#callback").submit(function(){var e=$(this);return $.ajax({type:"POST",url:"mail.php",data:e.serialize()}).done(function(){$(".success").addClass("visible"),setTimeout(function(){e.trigger("reset"),$(".success").removeClass("visible"),$.magnificPopup.close()},3e3)}),!1})});