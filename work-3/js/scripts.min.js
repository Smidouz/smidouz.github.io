...
$(function(){$(window).on("load",function(){var e=$(".loader_inner");e.find(".loader").fadeOut(),e.delay(350).fadeOut("slow")});new Swiper(".swiper-slider",{nextButton:".swiper-slider__button-prev",prevButton:".swiper-slider__button-next",speed:1e3,autoplay:7e3,loop:!0});$("a[rel='m_PageScroll2id']").mPageScroll2id(),$("main-header__nav-menu-link").click(function(){$(".main-header__overlay").toggleClass("-is-open")})});var Global=function(){"use strict";var e=function(){var e=$(".main-header__overlay"),n=$(".main-header__hamburger"),a=$(".main-header__nav-menu-link"),o=$(".main-header");a.on("click",function(){e.toggleClass("-is-open"),n.toggleClass("open"),o.toggleClass("-is-open")})},n=function(){var e=$(".main-header__overlay"),n=$(".main-header__hamburger"),a=$(".main-header");n.on("click",function(){e.toggleClass("-is-open"),n.toggleClass("open"),a.toggleClass("-is-open")})};return{init:function(){e(),n()}}}();$(document).ready(function(){Global.init()});var Parallax=function(){"use strict";var e=function(){$(".js__parallax-window").parallax("50%",.1)};return{init:function(){e()}}}();$(document).ready(function(){Parallax.init()});var HeaderSticky=function(){"use strict";var e=function(){$(".main-header").offset().top>15&&$(".main-header").addClass("s-header__shrink"),$(window).on("scroll",function(){$(".main-header").offset().top>15?$(".main-header").addClass("s-header__shrink"):$(".main-header").removeClass("s-header__shrink")})};return{init:function(){e()}}}();$(document).ready(function(){HeaderSticky.init()});var ButtonScroll=function(){"use strict";var e=function(){$(".btn-scroll-to-top").offset().top>1500&&$(".btn-scroll-to-top").addClass("-is-visible"),$(window).on("scroll",function(){$(".btn-scroll-to-top").offset().top>1500?$(".btn-scroll-to-top").addClass("-is-visible"):$(".btn-scroll-to-top").removeClass("-is-visible")})};return{init:function(){e()}}}();$(document).ready(function(){ButtonScroll.init()}),$(document).ready(function(){$(".s-portfolio").magnificPopup({delegate:"a",type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.',titleSrc:function(e){return e.el.attr("title")+"<small>by WEBenny.com </small>"}}})});