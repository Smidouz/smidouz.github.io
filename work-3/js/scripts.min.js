...
$(function(){$(window).on("load",function(){var e=$(".loader_inner");e.find(".loader").fadeOut(),e.delay(350).fadeOut("slow")});new Swiper(".swiper-slider",{nextButton:".swiper-slider__button-prev",prevButton:".swiper-slider__button-next",speed:1e3,autoplay:7e3,loop:!0});$("a[rel='m_PageScroll2id']").mPageScroll2id(),$("main-header__nav-menu-link").click(function(){$(".main-header__overlay").toggleClass("-is-open")})});var Global=function(){"use strict";var e=function(){var e=$(".main-header__overlay"),i=$(".main-header__hamburger"),n=$(".main-header__nav-menu-link"),a=$(".main-header");n.on("click",function(){e.toggleClass("-is-open"),i.toggleClass("open"),a.toggleClass("-is-open")})},i=function(){var e=$(".main-header__overlay"),i=$(".main-header__hamburger"),n=$(".main-header");i.on("click",function(){e.toggleClass("-is-open"),i.toggleClass("open"),n.toggleClass("-is-open")})};return{init:function(){e(),i()}}}();$(document).ready(function(){Global.init()});var Portfolio=function(){"use strict";var e=function(){$("#js__grid-portfolio-gallery").cubeportfolio({filters:"#js__filters-portfolio-gallery",layoutMode:"grid",mediaQueries:[{width:1500,cols:3},{width:1100,cols:3},{width:800,cols:3},{width:480,cols:2},{width:320,cols:1}],defaultFilter:"*",gapHorizontal:2,gapVertical:2,gridAdjustment:"responsive",caption:" ",lightboxDelegate:".cbp-lightbox",lightboxGallery:!0,lightboxTitleSrc:"data-title"})};return{init:function(){e()}}}();$(document).ready(function(){Portfolio.init()});var Parallax=function(){"use strict";var e=function(){$(".js__parallax-window").parallax("50%",.1)};return{init:function(){e()}}}();$(document).ready(function(){Parallax.init()});var HeaderSticky=function(){"use strict";var e=function(){$(".main-header").offset().top>15&&$(".main-header").addClass("s-header__shrink"),$(window).on("scroll",function(){$(".main-header").offset().top>15?$(".main-header").addClass("s-header__shrink"):$(".main-header").removeClass("s-header__shrink")})};return{init:function(){e()}}}();$(document).ready(function(){HeaderSticky.init()});