...
$(function(){$(".main-banner__sliders").owlCarousel({items:1,nav:!0,navText:"",smartSpeed:1e3}),$(".client__carousel").owlCarousel({loop:!0,nav:!0,navText:"",smartSpeed:500,autoWidth:!0,margin:58}),$(".navbar-mmenu").mmenu({extensions:["fx-menu-slide","fx-panels-slide-100","fx-listitems-slide"],navbar:{title:""}});var e=$(".navbar-mmenu").data("mmenu");$("#toggle").click(function(){e.open(),e.close()})});